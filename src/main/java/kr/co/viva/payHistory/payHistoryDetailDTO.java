...
public class payHistoryDetailDTO {
	...
	public payHistoryDetailDTO() {
		super();
	}
	public payHistoryDetailDTO(int resNum, int personCnt, int loc, int payNum, int payPrice, int installment, Date payDate,
