...
public class AdminPerformDTO {
	private int perfNum, perfType, perfLoc, perfShowTime, perfPrice;
	private String perfTitle, perfSubTitle, perfTime, perfPreview, perfImg, perfDelFlag;
	private Date perfStartDate, perfEndDate, perfInputDate;
	...
	public AdminPerformDTO() {
	}




	public AdminPerformDTO(int perfNum, int perfType, int perfLoc, int perfShowTime, int perfPrice, String perfTitle,
			String perfSubTitle, String perfTime, String perfPreview, String perfImg, String perfDelFlag,
	...
	public String toString() {
		return "performDTO [perfNum=" + perfNum + ", perfType=" + perfType + ", perfLoc=" + perfLoc + ", perfShowTime="
				+ perfShowTime + ", perfPrice=" + perfPrice + ", perfTitle=" + perfTitle + ", perfSubTitle="
				+ perfSubTitle + ", perfTime=" + perfTime + ", perfPreview=" + perfPreview + ", perfImg=" + perfImg
				+ ", perfDelFlag=" + perfDelFlag + ", perfStartDate=" + perfStartDate + ", perfEndDate=" + perfEndDate
				+ ", perfInputDate=" + perfInputDate + "]";
	}
