...
public class AdminQnaRangeDTO {
	...
	public String getFieldStr() {
		String[] fieldTitle = {"inquiry_title","id","has_return"};
	...
	public String toString() {
		return "QnaRangeDTO [startNum=" + startNum + ", endNum=" + endNum + ", field=" + field + ", keyword=" + keyword
