...
<body>
	<div class="wrap">
		...
		<!-- 메인 공간(비어있는 흰 배경 영역) -->
		<div class="container" style="min-height:970px !important;">
		<c:choose>
		<c:when test="${param.type==1}">
		<div style="margin:0px auto;min-height:400px; min-width:800px;display:flex; align-items: center; justify-content: center;">
			<img src="${CommonURL }/images/inquiryAddSuccess.png" style="margin-top:200px; min-width:800px;"/>
		</div>
		<div style="margin:0px auto;min-height:50px; min-width:800px;display:flex; align-items: center; justify-content: center;">
			<input type="button" value="문의 내역" onclick="location.href='${CommonURL}/inquiry/InquiryHistory.jsp'" 
            style="font-size:25px; color: #FF6124; border: 2px solid #FF6124; border-radius: 10px; background-color: #fff; margin-left:20px;" />
		</div>
		</c:when>
		<c:when test="${param.type==2}">
		<div style="margin:0px auto;min-height:400px; min-width:800px;display:flex; align-items: center; justify-content: center;">
			<img src="${CommonURL }/images/inquiryModifySuccess.png" style="margin-top:200px; min-width:800px;"/>
		</div>
		<div style="margin:0px auto;min-height:50px; min-width:800px;display:flex; align-items: center; justify-content: center;">
			<input type="button" value="문의 내역" onclick="location.href='${CommonURL}/inquiry/InquiryHistory.jsp'" 
            style="font-size:25px; color: #FF6124; border: 2px solid #FF6124; border-radius: 10px; background-color: #fff; margin-left:20px;" />
		...
		<div style="margin:0px auto;min-height:400px; min-width:800px;display:flex; align-items: center; justify-content: center;">
			<img src="${CommonURL }/images/removeSuccess.png" style="margin-top:200px; min-width:800px;"/>
		</div>
		<div style="margin:0px auto;min-height:50px; min-width:800px;display:flex; align-items: center; justify-content: center;">
			<input type="button" value="문의 내역" onclick="location.href='${CommonURL}/inquiry/InquiryHistory.jsp'" 
            style="font-size:25px; color: #FF6124; border: 2px solid #FF6124; border-radius: 10px; background-color: #fff; margin-left:20px;" />
		...
		<c:otherwise>
		<div style="margin:0px auto;min-height:400px; min-width:800px;display:flex; align-items: center; justify-content: center;">
			<img src="${CommonURL }/images/failMsg.png" style="margin-top:200px; min-width:800px;"/>
		</div>
		<div style="margin:0px auto;min-height:50px; min-width:800px;display:flex; align-items: center; justify-content: center;">
			<input type="button" value="문의 내역" onclick="location.href='${CommonURL}/inquiry/InquiryHistory.jsp'" 
            style="font-size:25px; color: #FF6124; border: 2px solid #FF6124; border-radius: 10px; background-color: #fff; margin-left:20px;" />
