...
<link href="http://192.168.10.71/jsp_prj/common/css/sign-in.css" rel="stylesheet">
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
	...
	<main class="form-signin w-100 m-auto">
		<form id="loginFrm" name="loginFrm" action="loginFrmProcess.jsp" method="post">
		<input type="hidden" name="returnUrl" value="${param.returnUrl}">
		
			<img class="mb-4" src="&{ CommonURL }/common/images/favicon.ico"
				alt="">
