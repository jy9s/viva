...
<body>
<form name="frm" id="frm" action="passModifyProcess.jsp" method="post">
			...
			<div class="character-wrap">
			  ...
			  <div class="title-text">비밀번호 찾기</div>
				...
				<div class="pass-info">
			  	...
			  	<div class="pass-info-desc">새로 설정할<br>비밀번호를 입력해주세요.</div>
				</div>
			<div class="info-form">
			<div class="info-form-line">
			</div>
			<div class="input-group mb-3"  style="width: 800px; left:20%;">
			 <span class="input-group-text" style="width:140px;">새 비밀번호</span>
  <input type="password" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" id="pass" name="newPass">
</div>	
		<div class="input-group mb-3" style="width: 800px; left:20%;">
		<span class="input-group-text" style="width:140px;">새 비밀번호 확인</span>
  <input type="password" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1"id="pass-chk" name="newPassChk">
</div>
