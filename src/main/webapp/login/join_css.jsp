   ...
   <form name="joinFrm" id="joinFrm" action="joinProcess.jsp">
      <table id="joinFrmTd">
         ...
         <tr>
            ...
            <td class="joinInput">
            <input type="text" id="user_id" name="user_id" class="inputBox" value="" readonly>
         ...
         <tr>
            ...
            <td class="joinInput">
            <input type="password" id="user_pw" name="user_pw" class="inputBox" value=""></td>
         </tr>

         <tr>
            <td class="joinInput">
            <input type="password" id="user_pw2" name="user_pw2" class="inputBox" placeholder="비밀번호 확인" value=""></td>
         </tr>
         ...
         <tr>
            ...
            <td class="joinInput">
            <input type="text" id="user_name" name="user_name" class="inputBox" value=""></td>
         </tr>
         ...
         <tr>
            ...
            <td class="joinInput"><input type="date" id="birth"
               name="birth" class="inputBox" value=""></td>
         </tr>
         ...
         <tr>
            ...
            <td class="joinInput"><input type="text" name="email1"
               class="inputBox email" value=""> @ <input type="text" list="domain"
               name="email2" class="inputBox email" value=""> <datalist id="domain">
         ...
         <tr>
            <td class="joinInput"><input type="text" id="addrDetail"
               ...
               placeholder="상세 주소를 입력해주세요." value=""></td>
         </tr>
